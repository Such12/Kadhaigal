import { FlowerDoodle, SpiralDoodle, CurlyArrow } from './Doodles.jsx'
    ...
    <section className="relative bg-brand-cream overflow-hidden">
      <div className="container-page grid lg:grid-cols-[1fr_1.3fr] gap-8 items-stretch py-16 sm:py-20">
        <div className="relative flex items-center">
          <FlowerDoodle className="hidden sm:block absolute -top-2 left-0 w-9 h-9" color="#142950" />
          <SpiralDoodle className="hidden sm:block absolute bottom-0 -left-2 w-8 h-8" color="#142950" />
          <h2 className="font-display font-extrabold uppercase text-brand-brick text-4xl sm:text-5xl lg:text-6xl leading-[0.95]">
        ...
        <div className="relative bg-brand-brick rounded-2xl min-h-[320px] sm:min-h-[420px] flex items-center justify-center overflow-hidden">
          <CurlyArrow
            className="absolute top-16 left-10 w-24 h-16 opacity-90"
            color="#142950"
          />
