...
export default function BooksHero() {
  return (
    <section className="relative container-page pt-14 pb-14 sm:pt-20 sm:pb-20 lg:pb-32">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <img src={Pintoo} alt="Pintoo" className="w-64 md:w-80 justify-self-center md:justify-self-end md:mr-32" />
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Button as={Link} to="#staff-picks" variant="primary">
              Shop Now
            </Button>
      ...
      <div 
        className="hidden lg:block absolute left-0 right-0 bottom-0 h-8 bg-repeat-x bg-bottom bg-contain opacity-100" 
